...
// controls only render where showSearchControls is passed (the Deals tab) -
// everywhere else that whole row is left out entirely. Mirrors the buyer
// app's DashboardHeader with seller branding (blue, storefront mark).
    ...
    <>
      <View style={styles.topBar}>
        <View style={styles.brandRow}>
          ...
          >
            <Store size={18} color={theme.colors.onPrimary} />
          </LinearGradient>
          <View>
