...
export default function LanguageSettingsScreen({ navigation }) {
  ...
  const handleSelect = async (code) => {
    ...
    // to the profile so it follows the seller to other devices, and so the
    // backend sends notifications in this language.
    setLanguage(code);
    ...
    <View style={styles.screen}>
      ...
      >
        <View style={styles.heroCard}>
          ...
          <Text style={styles.heroSubtitle}>{t("languageSettings.sellerHeroSubtitle")}</Text>
        </View>
